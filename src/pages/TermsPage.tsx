          ...
          <div className="flex flex-col gap-12">
            ...
            <section className="glass-card p-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Welcome to AlloX. These Terms of Service ("Terms") govern your access to and use of the AlloX platform, including our website, applications, and services (collectively, the "Platform"). The Platform is operated by AlloX Ltd ("AlloX," "we," "us," or "our").
                </p>
                <p>
            ...
            <section className="glass-card p-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  The Platform, including all content, features, functionality, AI algorithms, and design, is owned by AlloX Ltd and protected by intellectual property laws.
                </p>
                <p>
            ...
            <section className="glass-card p-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  These Terms shall be governed by and construed in accordance with the laws of the jurisdiction where AlloX Ltd is organized, without regard to conflict of law principles.
                </p>
              </div>
            </section>
