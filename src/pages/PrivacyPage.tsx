          ...
          <div className="flex flex-col gap-12">
            ...
            <section className="glass-card p-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  AlloX Ltd ("AlloX," "we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Platform.
                </p>
                <p>
            ...
            <section className="glass-card p-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                  <p className="font-medium mb-2">AlloX Ltd.</p>
                  <p className="text-sm">
