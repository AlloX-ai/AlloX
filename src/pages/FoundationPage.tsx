...
export function FoundationPage() {
   ...
   const brandAssets = [
    {
      ...
      description: 'Primary logos, variations, and usage guidelines',
      format: 'ZIP (SVG, PNG)',
      size: '2.4 MB'
    },
 ...
 useEffect(()=>{
  ...
  return (
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed animate-slide-up">
            The AlloX Foundation builds AI-powered infrastructure that transforms market narratives into diversified, risk-managed portfolios.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">The AlloX Advantage</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <GlassCard className="p-8">
              ...
              <h3 className="text-xl font-bold mb-3">Narrative Intelligence Engine</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                AlloX continuously maps market narratives to on-chain assets using proprietary market signals and continuous model iteration.
              </p>
            </GlassCard>
            ...
            <GlassCard className="p-8">
              ...
              <h3 className="text-xl font-bold mb-3">Execution Depth Across On Chain Actions</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                Portfolio construction, swaps, staking, rebalancing, and routing are executed natively on-chain in a single workflow.
              </p>
            </GlassCard>
            ...
            <GlassCard className="p-8">
              ...
              <h3 className="text-xl font-bold mb-3">Data Flywheel From Real Capital Allocation</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                Every allocation, rebalance, and user decision feeds back into portfolio construction and risk models.
              </p>
            </GlassCard>
            ...
            <GlassCard className="p-8">
              ...
              <h3 className="text-xl font-bold mb-3">Trust and Composability Layer</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                Transparent weights, on-chain execution, and auditable logic enable integrations with wallets, protocols, and institutional workflows.
              </p>
            </GlassCard>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <GlassCard hover className="p-8">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                A comprehensive overview of AlloX's vision for narrative-based investing and our AI-powered basket construction methodology.
              </p>
            ...
            <GlassCard hover className="p-8">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                AlloX의 내러티브 기반 투자 비전 및 AI 기반 바스켓 구성 방법론에 대한 포괄적인 개요.
              </p>
      ...
      {/* Brand Assets */}
      <section id='brand' className="py-24 px-6 bg-gradient-to-b from-transparent to-gray-50/50">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Brand Assets</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {brandAssets.map((asset, index) => (
              <GlassCard key={index} hover className="p-8 flex flex-col justify-center align-center">
                ...
                <a href='https://cdn.worldofdypians.com/AlloXBrand.zip' download target='_blank' className="btn-secondary w-full justify-center text-sm">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 bg-black rounded-full mt-2 flex-shrink-0"></div>
                <span>Use official brand colors from the guidelines document</span>
              </li>
            </ul>
          </GlassCard>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          <GlassCard className="p-12 md:p-16 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Whether you're a builder, researcher, or community member, there's a place for you in the AlloX ecosystem.
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Link to="/docs" className="btn-primary justify-center">
                Read Documentation
              </Link>
              <a href="mailto:contact@allox.ai" className="btn-secondary justify-center">
                Become a Partner
              </a>
            </div>
          </GlassCard>
